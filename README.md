...
1. Reset your database from the backup ```./reset_database.sh from-backup```.
2. Change your environment to ```staging```. Before starting the application, run ```export FLASK_ENV=staging```
