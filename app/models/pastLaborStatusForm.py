...
# # I want to get rid of this table entirely. All the information can be stored in the LaborStatusForm object, including
# # a flag to say status (pending, accepted, rejected, ...)
...
#     pastLaborStatusFormID       = IntegerField(primary_key = True)
