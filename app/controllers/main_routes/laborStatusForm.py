...
@main_bp.route("/laborstatusform/getPositions/<departmentOrg>/<deparmtentAcct>", methods=['GET'])
def getPositions(departmentOrg, deparmtentAcct):
    """ Get all of the positions that are in the selected department """
    positions = Tracy().getPositionsFromDepartment(departmentOrg,deparmtentAcct)
    positionDict = {}
