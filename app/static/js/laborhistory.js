function fillPDF(laborStatusKey){
  $.ajax({
    ...
    success: function(response) {
      ...
      //alert(response);
      var doc = new jsPDF();
      doc.fromHTML(response, 20, 170, {'width':155});
      doc.save();
  ...
  //
  //
  // doc.fromHTML("<ul><li>"+ primList_1+ "</li></ul>", 20, 200, {'width':155});
  // doc.fromHTML("<ul><li>"+ primList_2+"</li></ul>", 20, 210, {'width':155});
  // doc.fromHTML("<ul><li>"+ primList_3+"</li></ul>", 20,220, {'width':155});
  //
  // doc.setFontSize(10);
