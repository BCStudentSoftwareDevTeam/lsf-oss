...
function createAndFillTable(studentDict) {
  ...
  var notesGlyphicon = "<a href=\"#\" data-toggle=\"modal\" aria-label=\"View Notes\" onclick = \"showNotesModal(this)\" id= \"nGlyphicon\" ><span class=\"glyphicon glyphicon-edit\"></span></a>";
  var removeIcon = "<a href=\"#\" onclick= \"deleteRow(this)\" aria-label=\"Remove Row\" id=\"rGlyphicon\"><span class=\"glyphicon glyphicon-remove\" style=\"color:red;\"></span></a>";
