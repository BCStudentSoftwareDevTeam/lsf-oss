...
function modal(button) {
  if(button == "add" && $("#addlaborAdmin").val() != "") {
    ...
    $("h2").html("Labor Administrators");
    $("p").html("Are you sure you want to add " + $("#addFinAidAdmin option:selected").text() + " as an admin?");
    ...
    $("p").html("Are you sure you want to add " + $("#addSaasAdmin option:selected").text() + " as an admin?");
    ...
    $("h2").html("Financial Aid Administrators");
    $("p").html("Are you sure you want to remove " + $("#removelaborAdmin option:selected").text() + "?");
    ...
    $("p").html("Are you sure you want to remove " + $("#removeFinAidAdmin option:selected").text() + "?");
    ...
    $("h2").html("SAAS Administrators");
    $("p").html("Are you sure you want to remove " + $("#removeSaasAdmin option:selected").text() + "?");
